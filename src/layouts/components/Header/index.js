...
import 'tippy.js/dist/tippy.css'; // different import path!
...
const MENU_ITEMS = [
    {
        icon: <FontAwesomeIcon icon={faEarthAsia} className={cx('icon-menu-item')} />,
        title: 'English',
        children: {
            title: 'Languages',
            data: [
    ...
    {
        icon: <FontAwesomeIcon icon={faCircleQuestion} className={cx('icon-menu-item')} />,
        title: 'Feedback and help',
        to: '/feedback',
    },
    {
        icon: <FontAwesomeIcon icon={faKeyboard} className={cx('icon-menu-item')} />,
        title: 'Keyboard shortcuts',
    },
];

function Header(hideOnClick) {
    ...
    const handleMenuChange = (menuItem) => {
        switch (menuItem.type) {
            case 'language':
                // handle logic for changing language
                break;
            default:
            // handle other cases
        }
    ...
    const userMenu = [
        {
            icon: <FontAwesomeIcon icon={faUser} style={{ marginRight: 8 }} />,
            title: 'View Profile',
            to: '/@hoaa',
        },
        {
            icon: <FontAwesomeIcon icon={faCoins} style={{ marginRight: 8 }} />,
            title: 'Get coins',
            to: '/coin',
        },
        {
        ...
        ...MENU_ITEMS,
        {
            icon: <FontAwesomeIcon icon={faSignOut} style={{ marginRight: 8 }} />,
            title: 'Log out',
            to: '/logout',
            separate: true,
        },
    ...
    //     return (
    //         <div tabIndex="-1" {...props} className={cx('Inbox-preview')}>
    //             <PopperWrapper>
    //                 <InboxPreview />
    //             </PopperWrapper>
    //         </div>
            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('actions')}>
                        ...
                        <>
                            ...
                            {!showInbox && (
                                <Tippy delay={[0, 50]} content="Inbox" placement="bottom">
                                    <button onClick={toggleInbox} className={cx('action-btn')}>
                                        {showInbox && <InboxPreview />}
                                        <InboxIcon />
                    ...
                    <Menu items={currentUser ? userMenu : MENU_ITEMS} onChange={handleMenuChange}>
                        {currentUser ? (
                            <Image
                                src="https://p16-sign-sg.tiktokcdn.com/aweme/100x100/tos-alisg-avt-0068/4da16dcd179156a0c74b742b716b8454.jpeg?lk3s=a5d48078&nonce=7008&refresh_token=d57aa0637b589925fced59a4cd9725c9&x-expires=1720177200&x-signature=G5077Ju1%2Fp%2BlJoHmKNHnguIV3Dg%3D&shp=a5d48078&shcp=81f88b70"
